...
pwd
conda info --envs
source /home/stan1/anaconda3/bin/activate mefts_decoder
cd /ivi/ilps/personal/stan1/meft_decoder_only

## Environment setting  #TODO: adjust to your own environment
export TRANSFORMERS_CACHE=/ivi/ilps/personal/stan1/hf_cache
export HF_DATASETS_CACHE=/ivi/ilps/personal/stan1/hf_cache
export HF_METRICS_CACHE=/ivi/ilps/personal/stan1/hf_cache
